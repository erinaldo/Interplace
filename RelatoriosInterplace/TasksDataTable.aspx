<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="TasksDataTable.aspx.cs" Inherits="TasksDataTable" %>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <asp:ObjectDataSource ID="GridViewDataSource" runat="server"
                    DataObjectTypeName="RelatoriosInterplace.Issue"
                    TypeName="RelatoriosInterplace.DataProvider"
                ...
                <asp:ObjectDataSource ID="ContactsDataSource" runat="server"
                    DataObjectTypeName="RelatoriosInterplace.Contact"
                    TypeName="RelatoriosInterplace.DataProvider"
