<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="EventScheduling.aspx.cs" Inherits="EventScheduling" %>
...
<asp:Content runat="server" ContentPlaceHolderID="mainContent">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server"
        DataObjectTypeName="RelatoriosInterplace.SchedulerAppointment"
        TypeName="RelatoriosInterplace.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server"
        DataObjectTypeName="RelatoriosInterplace.SchedulerResource"
        TypeName="RelatoriosInterplace.ResourceDataSourceHelper"
